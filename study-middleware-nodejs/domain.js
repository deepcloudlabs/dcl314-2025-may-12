...
const {tcKimlikNoValidator, ibanValidator, emailValidator} = require("./validations");

const EmployeeSchema = new Schema({
    "_id": {
        type: String,
        required: true,
        validate: [tcKimlikNoValidator, "Invalid TC Kimlik No."]
    },
    "fullname": {
        type: String,
        required: true,
    ...
    "iban": {
        type: String,
        required: true,
        validate: [ibanValidator, "Invalid IBAN"]
    },
    department: {
        type: String,
        required: true,
    ...
    email: {
        ...
        required: true,
        unique: true,
        validate: [emailValidator, "Invalid e-mail"]
    },
    photo: {
        type: String,
        required: false,
...
const getEmployeeModel = () => EmployeeModel;

const updateableFields = ["fullname", "salary", "iban", "photo", "department", "fulltime"];
