let jack = {
    ...
    promote: function(department) {
      if (this.departments.includes(department)) {
          throw new Error("Promote department already exists");
      }
...
let copyOfJack = JSON.parse(jackAsJson);
console.log("parsed jack:");
console.log(copyOfJack);
console.log("original jack object");
console.log(jack);
